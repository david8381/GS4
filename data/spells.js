(() => {
  ...
  const buff_spells = [
    ...
    spell({ id: 307, circle: "Cleric", name: "Benediction", effect_text: "+5 physical AS, +5 bolt AS, +5 non-bolt DS", cast_scope: "self_or_group", modifiers: { as_physical: 5, as_bolt: 5, non_bolt_ds: 5 } }),
    ...
    spell({ id: 414, circle: "Minor Elemental", name: "Elemental Defense III", effect_text: "+20 DS, +15 elemental TD", modifiers: { non_bolt_ds: 20, td_elemental: 15 }, scaling_notes: ["Earth Lore adds a physical-attack deflection chance; starts at low ranks and scales upward."] }),
    ...
    spell({ id: 430, circle: "Minor Elemental", name: "Elemental Barrier", effect_text: "+15 DS, +15 elemental TD", cast_scope: "self_only", modifiers: { non_bolt_ds: 15, td_elemental: 15 }, scaling_notes: ["Minor Elemental ranks above 30 add flat DS and elemental TD. Air Lore adds a chance to reduce incoming critical severity, which is not included in totals."] }),
    ...
    spell({ id: 507, circle: "Major Elemental", name: "Elemental Deflection", effect_text: "+20 DS", cast_scope: "self_only", modifiers: { non_bolt_ds: 20 }, scaling_notes: ["Major Elemental ranks add +1 DS per 2 ranks above 7."] }),
    ...
    spell({ id: 509, circle: "Major Elemental", name: "Strength", effect_text: "+15 strength bonus (+15 AS, reduced encumbrance)", cast_scope: "self_or_target", modifiers: { strength_bonus: 15, as_physical: 15 }, scaling_notes: ["Earth Lore adds +1 physical AS per seed 4 summation. This lore bonus is self-cast only."] }),
    ...
    // Ranger Base
    spell({ id: 601, circle: "Ranger", name: "Natural Colors", effect_text: "+10 DS with hiding bonus", cast_scope: "self_or_group", modifiers: { non_bolt_ds: 10 }, scaling_notes: ["Blessings Lore adds extra flat DS by seed 5 summation."] }),
    ...
    spell({ id: 712, circle: "Sorcerer", name: "Cloak of Shadows", effect_text: "+25 DS, +20 TD", cast_scope: "self_only", modifiers: { non_bolt_ds: 25, td_spiritual: 20, td_elemental: 20, td_mental: 20 }, scaling_notes: ["Sorcerer Base ranks add +1 DS per rank above 12, capped by level, and +1 TD per 10 ranks above 12, capped by level."] }),
    ...
    spell({ id: 905, circle: "Wizard", name: "Prismatic Guard", effect_text: "+5 physical DS, +20 bolt DS", cast_scope: "self_only", modifiers: { non_bolt_ds: 5, bolt_ds: 20 }, scaling_notes: ["Wizard Base ranks add +1 DS per 4 ranks above 5."] }),
    ...
    spell({ id: 913, circle: "Wizard", name: "Melgorehn's Aura", effect_text: "+10 DS, +20 elemental TD", cast_scope: "self_only", modifiers: { non_bolt_ds: 10, td_elemental: 20 }, scaling_notes: ["Wizard Base ranks above 13 add flat DS and elemental TD."] }),
    ...
    spell({ id: 1007, circle: "Bard", name: "Kai's Triumph Song", effect_text: "+10 AS", cast_scope: "self_or_group", stack_mode: "song_not_stackable", modifiers: { as_physical: 10 }, scaling_notes: ["Bard Base ranks above 7 add +1 AS each, up to +20 total from songs known. Telepathy Lore adds +1 AS per seed 3 summation, up to +11 additional AS."] }),
    ...
    spell({ id: 1119, circle: "Empath", name: "Strength of Will", effect_text: "+12 spiritual TD, +12 DS", cast_scope: "self_only", modifiers: { td_spiritual: 12, non_bolt_ds: 12 }, scaling_notes: ["Empath Base ranks add +1 DS and +1 spiritual TD per 3 ranks above 19, up to +25 total DS/TD at 58 ranks."] }),
    ...
    spell({ id: 1130, circle: "Empath", name: "Intensity", effect_text: "+20 AS, +20 DS", cast_scope: "self_only", modifiers: { as_physical: 20, non_bolt_ds: 20 }, scaling_notes: ["Empath Base ranks add +1 AS and +1 DS per 2 ranks above 30, capped by level."] }),
    ...
    // Paladin Base
    spell({ id: 1601, circle: "Paladin", name: "Mantle of Faith", effect_text: "+5 DS, +5 spiritual TD", stack_mode: "not_stackable", modifiers: { non_bolt_ds: 5, td_spiritual: 5 }, scaling_notes: ["Self-cast only: Blessings Lore adds +1 DS and +1 spiritual TD by seed 2 summation."] }),
    ...
    spell({ id: 1610, circle: "Paladin", name: "Higher Vision", effect_text: "+10 DS", cast_scope: "self_only", modifiers: { non_bolt_ds: 10 }, scaling_notes: ["Paladin Base ranks add +1 DS per 2 ranks above 10, up to +55 total DS at 100 ranks. Religion Lore adds +1 DS by seed 5 summation."] }),
      ...
      rules: [
        {
          ...
          maxExtra: 10,
          cap_factor: "level",
          modifierKeys: ["as_physical", "as_bolt", "non_bolt_ds"],
          note: "+1 physical AS, +1 bolt AS, and +1 DS per 2 Cleric ranks above 7, capped by level",
        },
        {
          type: "ranks_above_threshold",
          factor: "cleric_spell_ranks",
      ...
      rules: [
        {
          ...
          maxExtra: 10,
          cap_factor: "level",
          modifierKeys: ["non_bolt_ds", "td_spiritual", "td_elemental", "td_mental"],
          note: "+1 DS and +1 TD per Cleric rank above 10, capped by level, max +20 total",
        },
      ],
    },
    313: {
      ...
      rules: [
        {
          ...
          note: "+10 DS at 35 Cleric ranks, then +1 DS per Cleric rank above 35",
        },
      ],
    },
    425: {
      ...
      rules: [
        {
          ...
          divisor: 2,
          cap_factor: "level",
          modifierKeys: ["non_bolt_ds", "td_elemental"],
          note: "+1 DS and +1 elemental TD per 2 Minor Elemental ranks above 30, capped by level",
        },
      ],
    },
    509: {
      ...
      rules: [
        {
          ...
          note: "Earth Lore adds flat AS by seed 4 summation",
        },
      ],
    },
    503: {
      ...
      rules: [
        {
          ...
          divisor: 4,
          modifierKeys: ["non_bolt_ds"],
          note: "+1 DS per 4 Major Elemental ranks above 3",
        },
      ],
    },
    507: {
      ...
      rules: [
        {
          ...
          divisor: 2,
          modifierKeys: ["non_bolt_ds"],
          note: "+1 DS per 2 Major Elemental ranks above 7",
        },
      ],
    },
    905: {
      ...
      rules: [
        {
          ...
          divisor: 4,
          modifierKeys: ["non_bolt_ds"],
          note: "+1 DS per 4 Wizard ranks above 5",
        },
      ],
    },
    513: {
      ...
      rules: [
        {
          ...
          maxExtra: 9,
          modifierKeys: ["non_bolt_ds"],
          note: "Blessings Lore adds flat DS by seed 5 summation",
        },
      ],
    },
    602: {
      ...
      rules: [
        {
          ...
          note: "+1 spiritual TD per 2 Ranger ranks above 25, max +12 total",
        },
      ],
    },
    618: {
      ...
      rules: [
        {
          ...
          cap_factor: "level",
          modifierKeys: ["as_physical"],
          note: "+1 AS per Bard rank above 7, capped by level",
        },
        {
          type: "seed_sum",
          ...
          maxExtra: 11,
          modifierKeys: ["as_physical"],
          note: "Telepathy Lore adds flat AS by seed 3 summation",
        },
      ],
    },
    712: {
      ...
      rules: [
        {
          ...
          maxExtra: 88,
          modifierKeys: ["non_bolt_ds"],
          note: "+1 DS per Sorcerer rank above 12, capped by level",
        },
        {
          type: "ranks_above_threshold",
          factor: "sorcerer_spell_ranks",
      ...
      rules: [
        {
          ...
          divisor: 3,
          maxExtra: 13,
          modifierKeys: ["td_spiritual", "non_bolt_ds"],
          note: "+1 DS and +1 spiritual TD per 3 Empath ranks above 19, up to +25 total",
        },
      ],
    },
    1130: {
      ...
      rules: [
        {
          ...
          divisor: 2,
          cap_factor: "level",
          modifierKeys: ["as_physical", "non_bolt_ds"],
          note: "+1 AS and +1 DS per 2 Empath ranks above 30, capped by level",
        },
      ],
    },
    1601: {
      ...
      rules: [
        {
          ...
          factor: "spiritual_lore_blessings_ranks",
          seed: 2,
          modifierKeys: ["non_bolt_ds", "td_spiritual"],
          note: "Self-cast only: Blessings Lore adds +1 DS and +1 spiritual TD by seed 2 summation",
        },
      ],
    },
    1610: {
      ...
      rules: [
        {
          ...
          maxExtra: 45,
          modifierKeys: ["non_bolt_ds"],
          note: "+1 DS per 2 Paladin ranks above 10, up to +55 total",
        },
        {
          type: "seed_sum",
          ...
          seed: 5,
          modifierKeys: ["non_bolt_ds"],
          note: "Religion Lore adds +1 DS by seed 5 summation",
        },
      ],
    },
    1617: {
      ...
      rules: [
        {
          ...
          cap_factor: "level",
          modifierKeys: ["non_bolt_ds"],
          note: "+1 DS per Wizard rank above 13, capped by level",
        },
        {
          type: "ranks_above_threshold",
          factor: "wizard_spell_ranks",
      ...
      rules: [
        {
          ...
          cap_factor: "level",
          modifierKeys: ["non_bolt_ds"],
          note: "+1 DS per 2 Empath ranks above 9, capped by level",
        },
      ],
    },
    1208: {
